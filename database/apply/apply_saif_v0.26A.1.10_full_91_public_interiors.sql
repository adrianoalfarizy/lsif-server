...
main: BEGIN
    ...
    DECLARE v_confirm VARCHAR(96) DEFAULT '';
    ...
    SET v_confirm=COALESCE(@saif_confirm,'');
    IF v_confirm <> 'APPLY_91_OFFLINE_PUBLIC_INTERIORS' THEN
