-- ==========================================================
-- SAIF / LSIF Clean Runtime Schema Baseline — v0.24K.21L
-- Based on actual live DB alignment after v0.24K.21H/v0.24K.21J cleanup passes
-- Runtime/non-archive tables only. Archive tables are maintenance artifacts.
-- Fresh-install baseline only. Do not apply to an existing live DB without review.
-- ==========================================================
