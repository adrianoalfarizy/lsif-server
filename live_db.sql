...
-- Dumping data for table lsif_db.admin_logs: ~74 rows (approximately)
...
-- Dumping data for table lsif_db.beta_whitelist: ~3 rows (approximately)
...
-- Dumping data for table lsif_db.organization_members: ~2 rows (approximately)
...
-- Dumping data for table lsif_db.player_houses: ~1 rows (approximately)
...
-- Dumping data for table lsif_db.race_records: ~1 rows (approximately)
