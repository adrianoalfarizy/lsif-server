...
SET @public_candidates := @public_icons+@hospital_fallback;
SET @public_rendered := LEAST(91,@public_candidates);
SET @public_omitted := GREATEST(0,@public_candidates-@public_rendered);
...
SELECT 'MAP_ICON_ALLOCATOR_AND_CAPACITY_GATE' section,
       @public_icons public_db_icon_candidates,
       @hospital_fallback hospital_fallback_candidates,
       @public_candidates total_public_candidates,
       @public_rendered public_icons_rendered_max_91,
       @public_omitted public_icons_omitted_by_allocator_informational,
